...
{
    public partial class lcdi2c : Form
    {
        ...
        private void lcdi2c_Load(object sender, EventArgs e)
        {
            jeKonektovan = false;
            jeUploadovan = false;
            jeKreiran = false;
        ...
        private void lcdi2c_FormClosing(object sender, FormClosingEventArgs e)
        {
            lcd lcdfm = new lcd();
            lcdfm.Show();
            port.Close();
        ...
        private void lcdi2c_VisibleChanged(object sender, EventArgs e)
        {
        }
        ...
        private void kreirajSketch()
        {
            ...
            {
                MessageBox.Show("Polje za adresu displeja je prazno, unesite adresu displeja da bi ste nastavili!!!", "Upozorenje!!!");
            }
            else
            {
                string lcddir = "displeji2c";
                string lcdfil = "displeji2c\\displeji2c.ino";
                string lcdaddr = textBox2.Text;
                ...
                string ardsketch = "#include <LiquidCrystal_I2C.h> \n" +
        ...
        private void uploadujSketch()
        {
            ...
            string sketchLoc    = "\"displeji2c\\displeji2c.ino\" ";
